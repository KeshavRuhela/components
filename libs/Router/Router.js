 ...
 * @version: 1.2.7
 * @author Graidenix
 * @reference https://github.com/Graidenix/vanilla-router#readme
 *
 * @constructor
 *
...
Router.prototype._getHashQuery = function () {
    ...
    let query = (index !== -1) ? window.location.hash.substr(index) : "";
...
Router.prototype._findRoute = function () {
    ...
    return this.routes.some(function (route) {
        ...
        if (match) {
            match.shift();
            let query = _this._getQuery();
            let page = new Router.Page(fragment, query, match, _this._pageState, route.options);
...
Router.prototype._processUri = function () {
    let fragment = this._getFragment(),
        found;
...
Router.prototype.refresh = function () {
    ...
    let path = this._currentPage.uri + "?" + this._queryString;
...
Router.prototype.go = function (count) {
    ...
    let page = this._historyStack[count];
    if (!page) {
        return this;
    }
